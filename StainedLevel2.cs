...
public partial class StainedLevel2 : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        _button1.Pressed += () => ChangeColor(new Color(1, 0, 0)); // Red
    ...
    private void OnConfirmButtonPressed()
    {
        ...
        if (_currentIndex >= _sprites.Length)
        {
            if (CheckColorCombination())
            {
                ...
                var nextScenePath = "res://StainedGlassLevel3.tscn";
