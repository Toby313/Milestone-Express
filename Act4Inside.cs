...
public partial class Act4Inside : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        transitionTimer.WaitTime = 27.0f; // 14-second timer
    ...
    {
        var nextScenePath = "res://Act4ToStation.tscn"; // Change this to your next scene's path
